...
<body <?php echo $darkmode === "on" ? 'data-theme="dark"' : ""; ?>>
    ...
    <div class="github">
        <!-- GitHub Sponsors -->
        <a class="github-button" href="https://github.com/sponsors/GabrielSoaresV" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-heart" data-size="large" aria-label="Sponsor @GabrielSoaresV on GitHub">Sponsor</a>
        <!-- View on GitHub -->
        <a class="github-button" href="https://github.com/GabrielSoaresV/github-readme-streak-stats" data-color-scheme="no-preference: light; light: light; dark: dark;" data-size="large" aria-label="View GabrielSoaresV/github-readme-streak-stats on GitHub">View on GitHub</a>
        <!-- GitHub Star -->
        <a class="github-button" href="https://github.com/GabrielSoaresV/github-readme-streak-stats" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star GabrielSoaresV/github-readme-streak-stats on GitHub">Star</a>
    </div>
    ...
    <div class="container">
        <div class="properties">
            ...
            <form class="parameters">
                ...
                <input class="param" type="text" id="user" name="user" placeholder="GabrielSoaresV" pattern="^[A-Za-z\d-]{0,39}[A-Za-z\d]$" title="Up to 40 letters or hyphens but not ending with hyphen" />
        ...
        <div class="output top-bottom-split">
            ...
            <div class="bottom">
                <a href="https://github.com/GabrielSoaresV/github-readme-streak-stats/blob/main/docs/faq.md" target="_blank" class="underline-hover faq">
