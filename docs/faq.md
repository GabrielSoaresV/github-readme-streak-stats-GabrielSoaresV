...
A profile readme appears on your profile page when you create a repository with the same name as your username and add a `README.md` file to it. For example, the repository for the user [`GabrielSoaresV`](https://github.com/GabrielSoaresV) is located at [`GabrielSoaresV/GabrielSoaresV`](https://github.com/GabrielSoaresV/GabrielSoaresV).
...
```html
<a href="https://git.io/streak-stats"><img src="https://streak-stats.demolab.com?user=GabrielSoaresV"/></a>
```
<!-- prettier-ignore-end -->
...
```html
<picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://streak-stats.demolab.com?user=GabrielSoaresV&theme=dark" />
    <img src="https://streak-stats.demolab.com?user=GabrielSoaresV&theme=default" />
</picture>
```
<!-- prettier-ignore-end -->
...
See [Deploying it on your own](https://github.com/GabrielSoaresV/github-readme-streak-stats?tab=readme-ov-file#-deploying-it-on-your-own) in the Readme for detailed instructions.
